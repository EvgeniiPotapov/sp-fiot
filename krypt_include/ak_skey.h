...
/*! \brief Двупараметрическая функция для проведения действий с секретным ключом. */
 typedef int ( ak_function_skey_pointer )( ak_skey , ak_pointer , const size_t );
...
/*! \brief Структура секретного ключа -- базовый набор данных и методов контроля. */
 ...
 /*! \brief Флаги текущего состояния ключа */
  ...
  /*! \brief указатель на функцию получения хешированного значения от значения ключа */
   ak_function_skey_pointer *update;
};
...
/*! \brief Получение хешированного значения от ключа. */
 int ak_skey_update_compress_xor( ak_skey , ak_pointer , const size_t );
